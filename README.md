...
Tags: alleyinteractive, wp-swagger-generator
...
[![Testing Suite](https://github.com/alleyinteractive/wp-swagger-generator/actions/workflows/all-pr-tests.yml/badge.svg)](https://github.com/alleyinteractive/wp-swagger-generator/actions/workflows/all-pr-tests.yml)

Plugin/package to generate Swagger documentation for the WordPress REST API..
...
```bash
composer require alleyinteractive/wp-swagger-generator
```
...
```php
$plugin = Create_WordPress_Plugin\Swagger_API_Documentation_Generator\Swagger_API_Documentation_Generator();
